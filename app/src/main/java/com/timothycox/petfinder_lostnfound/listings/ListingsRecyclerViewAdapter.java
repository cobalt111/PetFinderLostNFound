...
import com.timothycox.petfinder_lostnfound.listings.ListingsFragment.OnListFragmentInteractionListener;
...
public class ListingsRecyclerViewAdapter extends RecyclerView.Adapter<ListingsRecyclerViewAdapter.ViewHolder> {
    ...
    public ListingsRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
